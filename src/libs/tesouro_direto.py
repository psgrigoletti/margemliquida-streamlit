"""
Módulo que implementa acesso aos dados do Tesouro Transparente
"""
...
class TesouroDireto:
    ...
    def __init__(self):
        logging.log(logging.INFO, "Inicializando TesouroDireto")
        self.titulos = None
    ...
    def atualizar_graficos(self):
        ...
        self.titulos = self._busca_titulos_tesouro_direto()
    ...
    def _busca_titulos_tesouro_direto(self):
    ...
    def _busca_vendas_tesouro(self):
    ...
    def _busca_recompras_tesouro(self):
    ...
    def _atualizar_eventos_grafico(self, fig):
        fig.add_trace(
            go.Scatter(
                x=[
                    pd.to_datetime("01-01-2010", dayfirst=True),
    ...
    def retornar_grafico_precos_tesouro_selic(self) -> go.Figure:
        """retornar_grafico_precos_tesouro_selic _summary_
    ...
    def retornar_grafico_taxas_tesouro_selic(self) -> go.Figure:
        """retornar_grafico_taxas_tesouro_selic _summary_
    ...
    def retornar_grafico_precos_tesouro_pre(self) -> go.Figure:
        """retornar_grafico_precos_tesouro_pre _summary_
    ...
    def retornar_grafico_taxas_tesouro_pre(self) -> go.Figure:
        """retornar_grafico_taxas_tesouro_pre _summary_
    ...
    def retornar_grafico_precos_tesouro_ipca(self) -> go.Figure:
        """retornar_grafico_precos_tesouro_ipca _summary_
    ...
    def retornar_grafico_taxas_tesouro_ipca(self) -> go.Figure:
        """retornar_grafico_taxas_tesouro_ipca _summary_
        ...
        self._atualizar_eventos_grafico(fig)
        fig.update_layout(
            legend=dict(
                x=0,
                y=-0.1,
