...
class Dividendos:
    """Classe que trabalha com os dividendos"""
    chave_carteira_global = None

    MONTHS = {1: 'Jan', 2: 'Fev', 3: 'Mar', 4: 'Abr', 5: 'Mai', 6: 'Jun',
              7: 'Jul', 8: 'Ago', 9: 'Set', 10: 'Out', 11: 'Nov', 12: 'Dez'}

    FULL_MONTHS = {1: '01-Janeiro', 2: '02-Fevereiro', 3: '03-Março',
    ...
    def retornar_dados(self, ticker, data_inicial, data_final):
        ...
        historico['NomeMês'] = historico['Mês'].apply(lambda x:
                                                      self.FULL_MONTHS[x])
    ...
    def retornar_grafico_tendencia(self, ticker, df):
        ...
        fig.add_annotation(x=1, y=0,
                           ...
                           xshift=0, yshift=-110, font=dict(size=12,
                                                            color="grey"),
                           align="left")
    ...
    def retornar_grafico_quantidade_pagamentos_anual(self, ticker, df):
        ...
        fig.update_layout(
            ...
            title={'text': "<b>" + ticker +
                   " - Número de vezes que pagou dividendos por ano",
                   'y': 0.9, 'x': 0.5,
                   'xanchor': 'center', 'yanchor': 'top'})
