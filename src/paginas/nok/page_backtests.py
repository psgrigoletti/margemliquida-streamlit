...
#     def __init__(self):
#         self.fastma = bt.indicators.SimpleMovingAverage(period=self.params.fast)
#         self.slowma = bt.indicators.SimpleMovingAverage(period=self.params.slow)
...
#             self.data.high(-self.params.entry_breakout_period),
#             period=self.params.entry_breakout_period,
#         )
#         self.exit_breakout = bt.indicators.Lowest(
#             self.data.low(-self.params.exit_breakout_period),
#             period=self.params.exit_breakout_period,
#         )
...
#         dataname=yf.download(ativo, "2020-01-01", "2023-05-01", auto_adjust=True)
#     )
...
#         cerebro.addanalyzer(
#             btanal.PeriodStats, _name="periodsstats", timeframe=bt.TimeFrame.Days
#         )
