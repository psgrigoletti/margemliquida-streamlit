...
def main():
    ...
    if st.button("Analisar"):
        ...
        benchmarks = yf.download(benchmarks_selecionados, start=data_inicial.strftime('%Y-%m-%d'),
                                 end=data_final.strftime('%Y-%m-%d'))["Adj Close"]
        ...
        for ck in st.session_state['carteiras'].keys():
            ...
            cotacoes = yf.download(acoes, start=data_inicial.strftime('%Y-%m-%d'),
                                   end=data_final.strftime('%Y-%m-%d'))['Adj Close']
