...
def retornar_lista_inicial():
    return [ItemClassificar("ACAO1", 10.5), ItemClassificar('ACAO2', 5.3),
            ItemClassificar("ACAO3", 1.1), ItemClassificar('ACAO4', 4.1),
            ItemClassificar("ACAO5", 11.1), ItemClassificar("ACAO6", 1.1)]


def retornar_lista_asc():
    return [ItemClassificar("ACAO1", 10.5, "5 lugar"), ItemClassificar('ACAO2', 5.3, "4 lugar"),
            ItemClassificar("ACAO3", 1.1, "1 lugar"), ItemClassificar(
                'ACAO4', 4.1, "3 lugar"),
            ItemClassificar("ACAO5", 11.1, "6 lugar"), ItemClassificar("ACAO6", 1.1, "1 lugar")]


def retornar_lista_desc():
    return [ItemClassificar("ACAO1", 10.5, "2 lugar"), ItemClassificar('ACAO2', 5.3, "3 lugar"),
            ItemClassificar("ACAO3", 1.1, "5 lugar"), ItemClassificar(
                'ACAO4', 4.1, "4 lugar"),
            ItemClassificar("ACAO5", 11.1, "1 lugar"), ItemClassificar("ACAO6", 1.1, "5 lugar")]
