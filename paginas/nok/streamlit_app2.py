...
hashed_passwords = stauth.Hasher(["guest"]).generate()
    ...
    with st.sidebar:
        show_pages(
            [
                ...
                Page(
                    "paginas/page_comparador_carteiras.py",
                    "Comparador de Carteiras",
                    ":straight_ruler:",
                ),
                Page(
                    "paginas/page_dividendos_por_acao.py",
                    "Dividendos por ação",
                    ":heavy_dollar_sign:",
                ),
                Page(
                    "paginas/page_dias_consecutivos.py",
                    "Estratégia Dias Consecutivos",
                    ":infinity:",
                ),
                Page("paginas/page_tesouro_direto.py", "Tesouro Direto", ":flag-br:"),
                Page(
                    "paginas/page_relatorio_focus.py", "Relatório Focus", ":newspaper:"
                ),
                Page("paginas/page_juros_futuros.py", "Juros Futuros", ":calendar:"),
                Page("paginas/page_inflacao.py", "Inflação no Brasil", ":dragon:"),
                Page(
                    "paginas/page_panorama_mercado.py",
                    "Panorama de Mercado",
                    ":coffee:",
                ),
                Page(
                    "paginas/page_rentabilidades_mensais.py",
                    "Rentabilidades Mensais",
                    ":1234:",
                ),
                Page(
                    "paginas/page_comparativo_fundamentos.py",
                    "Comparador de Fundamentos",
                    ":tophat:",
                ),
                Page("paginas/page_backtests.py", "Backtests", ":chart:"),
                Page(
                    "paginas/page_backtests_vbt.py", "Backtests com VectorBT", ":chart:"
                ),
                Section(name="Em desenvolvimento", icon=":computer:"),
                Page(
                    "paginas/page_analise_fundamentalista.py",
                    "Análise Fundamentalista",
                    ":bank:",
                ),
                Page(
                    "paginas/page_dividendos_maiores_pagadores.py",
                ...
                Page(
                    "paginas/page_test_webdriver.py", "Teste Webdriver", ":test_tube:"
                ),
            ],
        )
